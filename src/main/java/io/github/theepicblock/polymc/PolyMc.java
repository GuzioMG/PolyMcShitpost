...
public class PolyMc implements ModInitializer {
    ...
    @ApiStatus.Internal
    public static RegistryAccess.Frozen FALLBACK_REGISTRY_MANAGER_BASE = RegistryAccess.fromRegistryOfRegistries(BuiltInRegistries.REGISTRY);
    @ApiStatus.Internal
    public static RegistryAccess.Frozen FALLBACK_REGISTRY_MANAGER = FALLBACK_REGISTRY_MANAGER_BASE;
     ...
     * @deprecated When this PolyMap is meant to affect players, use {@link io.github.theepicblock.polymc.api.misc.PolyMapProvider#getPolyMap(ServerPlayer)} instead.
     */
    @Deprecated
